...
function floatchart() {
    new ApexCharts(document.querySelector("#all-earnings-graph"), {
        ...
        new ApexCharts(document.querySelector("#total-income-graph"), {
            ...
            series: [27, 23, 20, 17],
            colors: ["#14176C", "#E58A00", "#2CA87F", "#14176C"],
    ...
    var e = {
        ...
        fill: { colors: ["#14176C", "#14176C"], opacity: [1, 0.5] },
        grid: { strokeDashArray: 4 },
        series: [
    ...
    new ApexCharts(document.querySelector("#overview-chart-1"), e).render(),
        ...
        (e = {
            ...
            plotOptions: {
                radialBar: {
                    ...
                    track: { background: "#14176C50", strokeWidth: "50%" },
                    dataLabels: {
                        show: !0,
                        name: { show: !1 },
                        value: {
        ...
        new ApexCharts(document.querySelector("#monthly-report-graph"), {
            ...
            colors: ["#14176C", "#14176C", "#14176C", "#E58A00"],
